...
|---|---|---|---|
| INMEDIATO | EA = ninguna (el valor está embebido en el opcode) | `MOV ax, 100` | U 100 : `MOV AX,0064` (AX = 0064h = 100 decimal) |
| DIRECTO | EA = dirección fija codificada en la instrucción | `MOV ax, [var_x]` | U : `MOV AX,[01XX]`; D DS:01XX → `FF FF 00 00` |
| INDIRECTO POR REGISTRO | EA = [SI] o [BX] (contenido del registro) | `MOV ax, [si]` | T : SI = dir_nota1; AX = 0055h (85 decimal) |
| INDEXADO (BASE + ÍNDICE + DESPLAZAMIENTO) | EA = BX + SI + desplazamiento | `MOV ax, [bx + si]` | T : BX = dir_array, SI = 4; AX = 001Eh (30 decimal) |
